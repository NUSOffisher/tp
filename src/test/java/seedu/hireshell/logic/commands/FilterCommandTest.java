...
public class FilterCommandTest {
    ...
    public void execute_filterSuccessful() {
        ...
        PersonMatchesFiltersPredicate predicate = new PersonMatchesFiltersPredicate(null, "status");
    ...
    @Test
    public void equals() {
        PersonMatchesFiltersPredicate predicate1 = new PersonMatchesFiltersPredicate(null, "status1");
        PersonMatchesFiltersPredicate predicate2 = new PersonMatchesFiltersPredicate(null, "status2");
